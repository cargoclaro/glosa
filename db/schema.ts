...
import { boolean, doublePrecision, foreignKey, integer, pgEnum, pgTable, primaryKey, serial, text, timestamp, uniqueIndex } from 'drizzle-orm/pg-core'

export const OperationStatus = pgEnum('OperationStatus', ['IN_PROGRESS', 'DONE'])
...
export const CustomGloss = pgTable('CustomGloss', {
	...
	operationStatus: OperationStatus('operationStatus').notNull().default("IN_PROGRESS"),
...
export const CustomGlossTab = pgTable('CustomGlossTab', {
	...
	'CustomGlossTab_customGloss_fkey': foreignKey({
		...
		.onDelete('cascade')
		.onUpdate('cascade'),
	'CustomGlossTab_name_customGlossId_unique_idx': uniqueIndex('CustomGlossTab_name_customGlossId_key')
...
export const CustomGlossTabValidationStepActionToTake = pgTable('CustomGlossTabValidationStepActionToTake', {
	id: serial('id').notNull().primaryKey(),
	description: text('description').notNull(),
	customGlossTabValidationStepId: integer('customGlossTabValidationStepId').notNull(),
	createdAt: timestamp('createdAt', { precision: 3 }).notNull().defaultNow(),
	updatedAt: timestamp('updatedAt', { precision: 3 }).notNull()
}, (CustomGlossTabValidationStepActionToTake) => ({
	'CustomGlossTabValidationStepActionToTake_customGlossTabValidationStep_fkey': foreignKey({
		name: 'CustomGlossTabValidationStepActionToTake_customGlossTabValidationStep_fkey',
		columns: [CustomGlossTabValidationStepActionToTake.customGlossTabValidationStepId],
		foreignColumns: [CustomGlossTabValidationStep.id]
	})
		.onDelete('cascade')
		.onUpdate('cascade')
...
export const CustomGlossTabValidationStepResources = pgTable('CustomGlossTabValidationStepResources', {
	...
	'CustomGlossTabValidationStepResources_customGlossTabValidationStep_fkey': foreignKey({
		name: 'CustomGlossTabValidationStepResources_customGlossTabValidationStep_fkey',
		columns: [CustomGlossTabValidationStepResources.customGlossTabValidationStepId],
		foreignColumns: [CustomGlossTabValidationStep.id]
	})
		.onDelete('cascade')
		.onUpdate('cascade')
...
export const CustomGlossAlertRelations = relations(CustomGlossAlert, ({ one }) => ({
...
export const CustomGlossFileRelations = relations(CustomGlossFile, ({ one }) => ({
	customGloss: one(CustomGloss, {
		relationName: 'CustomGlossToCustomGlossFile',
...
export const CustomGlossTabRelations = relations(CustomGlossTab, ({ many, one }) => ({
...
export const CustomGlossTabContextRelations = relations(CustomGlossTabContext, ({ many, one }) => ({
...
export const CustomGlossTabContextDataRelations = relations(CustomGlossTabContextData, ({ one }) => ({
...
export const CustomGlossTabValidationStepRelations = relations(CustomGlossTabValidationStep, ({ many, one }) => ({
	resources: many(CustomGlossTabValidationStepResources, {
		relationName: 'CustomGlossTabValidationStepToCustomGlossTabValidationStepResources'
	}),
	actionsToTake: many(CustomGlossTabValidationStepActionToTake, {
		relationName: 'CustomGlossTabValidationStepToCustomGlossTabValidationStepActionToTake'
	}),
...
export const CustomGlossTabValidationStepActionToTakeRelations = relations(CustomGlossTabValidationStepActionToTake, ({ one }) => ({
	customGlossTabValidationStep: one(CustomGlossTabValidationStep, {
		relationName: 'CustomGlossTabValidationStepToCustomGlossTabValidationStepActionToTake',
		fields: [CustomGlossTabValidationStepActionToTake.customGlossTabValidationStepId],
		references: [CustomGlossTabValidationStep.id]
	})
}));

export const CustomGlossTabValidationStepResourcesRelations = relations(CustomGlossTabValidationStepResources, ({ one }) => ({
	customGlossTabValidationStep: one(CustomGlossTabValidationStep, {
		relationName: 'CustomGlossTabValidationStepToCustomGlossTabValidationStepResources',
		fields: [CustomGlossTabValidationStepResources.customGlossTabValidationStepId],
		references: [CustomGlossTabValidationStep.id]
	})
}));