...
const validationResultSchema = z.object({
  ...
  llmAnalysis: z.array(z.string()).describe(`Análisis detallado de la validación realizado por el LLM. Cada elemento debe comenzar con '✅' si es correcto, '⚠️' si hay advertencias, o '❌' si hay errores. Debe incluir una explicación paso a paso del proceso de validación, citando expresamente los valores específicos encontrados en cada documento del contexto. Si algún campo es null, debe indicar exactamente qué información falta y cómo afecta a la validación.`),
