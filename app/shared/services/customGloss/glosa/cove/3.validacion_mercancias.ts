 ...
 */
export async function validateMercanciasImportacion(
  cove: Cove,
  invoice: Invoice,
  carta318?: Carta318
) {
 ...
 */
export async function validateMercanciasExportacion(
  cove: Cove,
  carta318?: Carta318,
  cfdi?: Cfdi
) {
 ...
 * Compares with the invoice or Carta 318. In case of discrepancy, Carta 318 takes precedence.
 */
export async function validateValorTotalDolaresImportacion(
  cove: Cove,
  invoice: Invoice,
  carta318?: Carta318
) {
 ...
 * Compares with the CFDI or Carta 318. In case of discrepancy, Carta 318 takes precedence.
 */
export async function validateValorTotalDolaresExportacion(
  cove: Cove,
  carta318?: Carta318,
  cfdi?: Cfdi
) {
