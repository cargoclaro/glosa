...
export async function validateMercancias(
  ...
  const validation = {
    name: "Mercancias",
    description: "Validación que compara los datos de las mercancías entre el COVE, la Carta 3.1.8 y la factura comercial para asegurar que coincidan en operaciones de importación, incluyendo descripción, cantidad, unidad de medida, valor unitario y valor total.",
    prompt: "Validar que los siguientes datos de las mercancías en el COVE coincidan con los declarados en la Carta 3.1.8 (si existe) o en la factura comercial:\n\n• Descripción genérica de la mercancía\n• Cantidad en unidad de medida comercial (UMC)\n• Clave de unidad de medida comercial\n• Valor unitario\n• Valor total\n\nSi existe Carta 3.1.8, los datos declarados en ésta tienen prioridad sobre la factura comercial.",
    contexts: {
...
export async function validateNumeroSerie(
  ...
  const validation = {
    ...
    description: "Validación que compara el número de serie de las mercancías entre el COVE, la carta 3.1.8 y la factura comercial, verificando que coincidan exactamente como aparecen en los documentos correspondientes. Los números de serie no son obligatorios y se consideran válidos si no existen.",
