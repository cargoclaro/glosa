...
export async function validateTipoTransporte(pedimento: Pedimento) {
  ...
  const validation = {
    ...
    description: "Verificación de que la clave del tipo de transporte esté incluida en el apéndice 10",
...
export async function validateModalidadMedioTransporte(pedimento: Pedimento, transportDocument?: TransportDocument) {
  ...
  const validation = {
    ...
    description: "Verificación de coherencia entre la modalidad del documento de transporte y el medio de transporte declarado en el pedimento",
...
export async function validateNumeroGuiaEmbarque(pedimento: Pedimento, transportDocument?: TransportDocument) {
  ...
  const validation = {
    ...
    description: "Verificación de que el número de guía o embarque del pedimento coincida con el documento de transporte según el tipo de transporte utilizado",
