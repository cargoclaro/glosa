...
export async function validatePesosYBultos(pedimento: Pedimento, transportDocument?: TransportDocument, packingList?: PackingList, cfdi?: Cfdi) {
  ...
  const validation = {
    ...
    description: "Verificación de la consistencia de pesos brutos, netos y número de bultos entre el pedimento y los documentos soporte",
...
export async function validateBultos(pedimento: Pedimento, transportDocument?: TransportDocument) {
  ...
  const validation = {
    ...
    description: "Verificación de que el número total de bultos coincida entre el pedimento y el documento de transporte",
