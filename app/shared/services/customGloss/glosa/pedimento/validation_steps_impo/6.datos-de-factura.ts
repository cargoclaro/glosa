...
export async function validateRfcFormat(pedimento: Pedimento, cove: Cove, carta318?: Carta318) {
  ...
  const validation = {
    ...
    description: "Valida el formato y consistencia de los RFC entre el pedimento, COVE y carta 3.1.8",
...
export async function validateCesionDerechos(pedimento: Pedimento, cartaSesion?: CartaSesion, carta318?: Carta318) {
  ...
  const validation = {
    ...
    description: "Valida que los datos de la cesión de derechos coincidan con la carta 3.1.8 y que las fechas sean correctas",
...
export async function validateDatosImportador(pedimento: Pedimento, cove: Cove, carta318?: Carta318) {
  ...
  const validation = {
    ...
    description: "Valida que los datos del importador coincidan entre el pedimento, COVE y carta 3.1.8",
...
export async function validateMonedaYEquivalencia(pedimento: Pedimento, cove: Cove, carta318?: Carta318, invoice?: Invoice) {
  ...
  const validation = {
    ...
    description: "Valida que la moneda y los valores declarados coincidan entre los documentos y que el factor de conversión sea correcto",
