...
export const packingListSchema = z.object({
  ...
  totals: z.object({
    total_crates: z
      .number()
      .int()
      .describe("Total number of crates"),
  ...
  document_summary: z
    .string()
    .describe(
      "A detailed summary of all processed packing lists, including details of shipments and context that may be useful for a human. This field is mandatory and must be generated by the LLM, it is not provided in the document."
    )
})