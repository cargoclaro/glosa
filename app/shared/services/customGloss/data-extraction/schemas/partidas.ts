...
export const partidasSchema = z.object({
  ...
  p_v_c: z.string().min(3).max(3).describe('País de venta o compra'),
  p_o_d: z.string().min(3).max(3).describe('País de origen o destino'),
  contribuciones: z
    .array(
      z.object({
  ...
  identificadores: z.array(
    z.object({
      ...
      complemento1: z.string().describe('Primer complemento').optional(),
      complemento2: z.string().describe('Segundo complemento').optional(),
      complemento3: z.string().describe('Tercer complemento').optional(),
    })
  ),
  observaciones: z
