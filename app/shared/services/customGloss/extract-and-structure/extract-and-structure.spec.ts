  ...
  it('should extract and structure pedimento', async () => {
    const pedimentoFixture = [
      {
        ...
        expectedOutput: {
          ...
          "valores": {
            "valor_dolares": 7498.32,
            "valor_aduana": 151588,
            "precio_pagado_valor_comercial": 144547
          },
          "datos_importador": {
            "rfc": "EGM981125GX4",
            "curp": null,
            "razon_social": "HEXPOL COMPOUNDING QUERETARO S.A. DE C.V.",
          ...
          "fecha_entrada_presentacion": null,
          "cuadro_de_liquidacion": {
            "liquidaciones": [
              {
                "concepto": "IVA",
                "fp": 0,
          ...
          "identificadores_nivel_pedimento": {
            "clave_seccion_aduanera": "240",
            "marcas_numeros_bultos": "A-66151"
          },
          "id_fiscal": "13-5409005",
          "cove": null,
          "nombre_razon_social": "EXXONMOBIL CHEMICAL COMPANY",
          "domicilio": null,
          "vinculacion": "NO",
          "datos_factura": {
            "num_factura": "TS-25032025",
            "fecha_factura": "25/03/2025",
            "incoterm": "CPT",
            "moneda_factura": "USD",
            "valor_moneda_factura": 7150,
            "factor_moneda_factura": 1,
            "valor_dolares_factura": 7150
          },
          "no_guia_embarque_id": "string",
          "tipo_contenedor_vehiculo": "60",
          "identificadores_pedimento": [],
          "observaciones_a_nivel_pedimento": null,
          ...
          "partidas": [
            {
              ...
              "document_summary": "This entry describes the import of nickel powder. The quantity is 1.0 in both the commercial and tariff units of measure. The value of the goods is 151588.00 USD, with an import price paid of 144547.00. The country of origin and purchase is the USA. There is an IVA tax of 24254.0.",
              "firma_descargo": null,
              "fraccion": "75040001",
              "identificadores": [
                {
                ...
                {
                  "clave": "MA",
                  "complemento1": "IMPERIAL ALLOYS CORP",
                  "complemento2": null,
                  "complemento3": null
                },
                {
    ...
    const pedimentoResults = await Promise.all(
      pedimentoFixture.map(async ({ fileUrl }) => {
        const pedimentoResult = await extractAndStructurePedimento(fileUrl);
