...
export const airWaybillSchema = z.object({
  ...
  date: z.string().describe('The date of entry in YYYY-MM-DD format.'),
  origin_country: z
    .string()
    .describe(
  ...
  collect_value: z
    .object({
      valor: z.number(),
      moneda: z.string().describe('ISO 4217 currency code (e.g., USD, MXN)'),
    })
    .describe(
  ...
  currency: z.enum(['USD']).describe('The currency code for collect charges'),
      ...
      incrementables: z
        .object({
          ...
          seguros: z
            .object({
              valor: z.number(),
              moneda: z.string().describe('Currency code (e.g., USD, MXN)'),
            })
            .optional(),
          embalajes: z
            .object({
  ...
  mercancias: z
    .array(
      z.object({
        descripcion: z.string().describe('Description of the good').optional(),
        cantidad: z.number().describe('Quantity of the good').optional(),
        peso_neto: z.number().describe('Net weight of the good').optional(),
        peso_bruto: z.number().describe('Gross weight of the good').optional(),
        unidad: z
          .string()
          .describe("Unit of measure, e.g., 'KG', 'G', 'T', 'LB', 'OZ'")
          .optional(),
        precio_unitario: z
          ...
          .optional(),
        precio_total: z.number().describe('Total price of the good').optional(),
        moneda: z
          .string()
          .describe('ISO 4217 currency code (e.g., USD, MXN)')
          .optional(),
