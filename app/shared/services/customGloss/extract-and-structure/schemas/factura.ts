  ...
  .object({
    ...
    ship_to: z
      .object({
        name: z
          .string()
          .describe('Name of the company/person to whom the order is sent'),
    ...
    handling_amount: z
      ...
      .optional(),
    insurance_amount: z.number().describe('Insurance charges').optional(),
    additional_charges: z
      .array(
        z.object({
          description: z
            .string()
            .describe('Description of the additional charge'),
    ...
    total_amount: z
      .number()
      .describe('Total amount of the invoice including all charges and taxes'),
    amount_due: z
      .number()
      .describe(
        'Amount still due for payment (may differ from total if partially paid)'
      )
      .optional(),
    amount_paid: z.number().describe('Amount already paid').optional(),
    valor_comercial: z
      .number()
