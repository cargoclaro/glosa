...
export const reporteRemesaSchema = z.object({
  productos: z.array(reporteRemesaItemSchema).describe("Lista de productos en el reporte de remesa"),
...
export const reportesRemesaSchema = z.object({
  reportesRemesa: z.array(reporteRemesaSchema).describe("Lista de reportes de remesa, ya que puede haber más de uno"),
});
