...
export const mockPedimento: Pedimento = {
  ...
  datos_importador: {
    ...
    domicilio:
      'DARWIN, No. Ext. 74, No. Int. 301, ANZUREZ, C.P. 11590, MIGUEL HIDALGO, CIUDAD DE MÉXICO, MEXICO (ESTADOS UNIDOS MEXICANOS)',
  },
  incrementables: {
    val_seguros: 0,
    seguros: 0,
  ...
  domicilio:
    'PASEO OBISPO OTADUY No. 9-11, C.P. 20560, OÑATE (GUIPUZCOA), ESPAÑA (REINO DE)',
  vinculacion: 'SI',
  datos_factura: [
    {
      ...
      incoterm: 'EXW',
      moneda_factura: 'EUR',
      valor_moneda_factura: 22400.0,
      factor_moneda_factura: 1.0395,
      valor_dolares_factura: 23284.8,
    },
  ],
  ...
  observaciones_a_nivel_pedimento:
  ...
  partidas: [
    {
      ...
      met_val: '1',
      umc: '6',
      cantidad_umc: 32000.0,
      umt: '1',
      cantidad_umt: 1056.0,
      p_vic: 'ESP',
      p_oid: 'DEU',
      descripcion:
        'ELEMENTO DE ACERO PARA TUBOS(CRASHELEMENT 3MM BERUCOAT AF732)',
      val_adu_usd: null,
      imp_precio_pag: null,
      precio_unit: null,
      val_agreg: null,
