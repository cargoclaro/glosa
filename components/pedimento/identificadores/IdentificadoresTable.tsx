...
const IdentificadoresTable: React.FC<IdentificadoresTableProps> = ({ identificadores }) => {
  return (
    <div className="grid grid-cols-6 gap-0">
      ...
      {identificadores.map((identificador, index) => (
        <React.Fragment key={index}>
          <div className="pedimento-cell pedimento-value">{identificador.clave}</div>
          <div className="pedimento-cell pedimento-value">{identificador.complemento_1}</div>
          <div className="pedimento-cell pedimento-value">{identificador.complemento_2 || ""}</div>
          <div className="pedimento-cell pedimento-value">{identificador.complemento_3 || ""}</div>
